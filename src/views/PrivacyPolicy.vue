<template>
  <v-container>
    <h1>Privacy Policy for NweOo</h1>
    <p>
      At <a href="https://nweoo.com" target="_blank">nweoo.com</a>, accessible
      from <a href="https://nweoo.com" target="_blank">https://nweoo.com</a>,
      one of our main priorities is the privacy of our visitors. This Privacy
      Policy document contains types of information that is collected and
      recorded by <a href="https://nweoo.com" target="_blank">nweoo.com</a> and
      how we use it.
    </p>
    <p>
    ...
    <p>
      ...
      and/or collect in
      <a href="https://nweoo.com" target="_blank">nweoo.com</a>. This policy is
    ...
    <h2>Log Files</h2>
    <p>
      <a href="https://nweoo.com" target="_blank">nweoo.com</a> follows a
    ...
    <p>
      ...
      <a href="https://nweoo.com" target="_blank">nweoo.com</a> uses 'cookies'.
    ...
    <p>
      ...
      <a href="https://nweoo.com" target="_blank">nweoo.com</a>.
    </p>
    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on
      <a href="https://nweoo.com" target="_blank">nweoo.com</a>, which are sent
    ...
    <p>
      Note that
      <a href="https://nweoo.com" target="_blank">nweoo.com</a> has no access to
      or control over these cookies that are used by third-party advertisers.
    </p>
    <v-divider class="my-5"></v-divider>
    <h2>Third Party Privacy Policies</h2>
    <p>
      <a href="https://nweoo.com" target="_blank">nweoo.com</a>'s Privacy Policy
    ...
    <p>
      <a href="https://nweoo.com" target="_blank">nweoo.com</a> does not
